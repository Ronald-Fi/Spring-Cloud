package com.example.io.bio.tomcat;
...
public class TTomcat {
    ...
    private Map<String, TServlet> servletMapping = new HashMap<String, TServlet>();
        ...
        try {
            ...
            for (Object k : webxml.keySet()) {
                ...
                if (key.endsWith(".url")) {
                    ...
                    //单实例,多线程
                    TServlet obj = (TServlet) Class.forName(className).newInstance();
    ...
    public void start() {
        ...
        try {
            ...
            System.out.println("T Tomcat 已启动,监听的端口是：" + this.port);
    ...
    private void process(Socket client) throws Exception {
        ...
        TRequest request = new TRequest(is);
        TResponse response = new TResponse(os);
